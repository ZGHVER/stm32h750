...
#define LCD_LAYER0_FRAME_BUFFER  ((uint32_t)0xd0000000)     //第一层缓冲区
#define LCD_LAYER1_FRAME_BUFFER  ((uint32_t)0xd0300000)     //第二层缓冲区
...
//				LCD_SetDevFunc(i, LCD_DEVFUNC_DRAWBMP_32BPP, (void(*)(void))LCD_LL_DrawBitmap32bpp);
				LCD_SetDevFunc(i,LCD_DEVFUNC_DRAWBMP_32BPP,(void(*)(void))LCD_DrawBitmap32bpp);   
