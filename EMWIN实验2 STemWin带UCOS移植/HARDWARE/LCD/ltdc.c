...
//	u32 sclk = 292,pll = 7;
	...
	}else if(lcdid==0X7084)
	{
		...
		lcdltdc.hbp=46;					//水平后廊
		lcdltdc.vbp=23;					//垂直后廊
		lcdltdc.hfp=22+10;				//水平前廊
		lcdltdc.vfp=22+10;					//垂直前廊
//        LTDC_Clk_Set(396,3,RCC_PLLSAIDIVR_4); //设置像素时钟 33M(如果开双显,需要降低DCLK到:18.75Mhz  300/4/4,才会比较好)
		LTDC_Clk_Set(160,4,RCC_PLLSAIDIVR_4); //设置像素时钟 33M(如果开双显,需要降低DCLK到:18.75Mhz  300/4/4,才会比较好)
//		LTDC_Clk_Set(320,4,RCC_PLLSAIDIVR_4); //设置像素时钟 33M(如果开双显,需要降低DCLK到:18.75Mhz  300/4/4,才会比较好)
...
//    
    ...
    /* 初始化LCD的像素宽度和高度 */
    LTDC_Handler.LayerCfg->ImageWidth  = 800;
    LTDC_Handler.LayerCfg->ImageHeight = 480;
...
//    
//    //初始化PD7，背光引脚
//    GPIO_Initure.Pin=GPIO_PIN_7;                //PB5推挽输出，控制背光
...
//    
//    //初始化PG6,7,10,11,12
//    GPIO_Initure.Pin=GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12;
//    HAL_GPIO_Init(GPIOG,&GPIO_Initure);
//    
//    //初始化PH2,3,8,13,15
//    GPIO_Initure.Pin=GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_8|\
//                     GPIO_PIN_13|GPIO_PIN_15;
//    HAL_GPIO_Init(GPIOH,&GPIO_Initure);
//    
//    //初始化PI0,2,4,9,10
//    GPIO_Initure.Pin=GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_4|\
...
//    
 ...
 /* 红色数据线 */                        
  ...
  HAL_GPIO_Init(LTDC_DE_GPIO_PORT, &GPIO_InitStruct);
	...
	//初始化PD7，背光引脚
	GPIO_InitStruct.Pin=GPIO_PIN_7;                //PB5推挽输出，控制背光
