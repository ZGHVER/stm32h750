...
typedef void (*TOUCH_DOWN)(int32_t,int32_t,int32_t,int32_t);
typedef void (*TOUCH_UP)(int32_t);
...
// Log define
#define GTP_INFO(fmt,arg...)          0// printf("<<-GTP-INFO->> "fmt"\n",##arg)
#define GTP_ERROR(fmt,arg...)         0 //printf("<<-GTP-ERROR->> "fmt"\n",##arg)
#define GTP_DEBUG(fmt,arg...)         0 /*do{\
                                         if(GTP_DEBUG_ON)\
                                         printf("<<-GTP-DEBUG->> [%d]"fmt"\n",__LINE__, ##arg);\
																					}while(0)*/

#define GTP_DEBUG_ARRAY(array, num)  0 /* do{\
                                         int32_t i;\
                                         uint8_t* a = array;\
