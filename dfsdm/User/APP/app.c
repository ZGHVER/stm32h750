...
void SystemClock_Config1(){
  ...
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_LTDC|RCC_PERIPHCLK_DFSDM1
                              |RCC_PERIPHCLK_SAI1|RCC_PERIPHCLK_FMC | RCC_PERIPHCLK_SDMMC 
                              | RCC_PERIPHCLK_SAI23 | RCC_PERIPHCLK_SAI4A | 
